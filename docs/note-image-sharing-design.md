...
- 画布：暖米白背景，呼应当前应用的 `AppColors.canvas`。
- 信纸：一体化暖米白纸面，以克制的纤维与颗粒建立真实纸张质感。
- 装饰：不使用信封折角、邮票或右上角应用图标，避免与正文竞争。
- 标题：衬线字体、较大字号，最多展示三行，超过后正常分页而不是缩小。
...
样式选择采用单行横向滑动的纯文字标签，不使用图标。每套模板独立定义纸张比例、页边距、标题字重与对齐、背景、边框和装饰安全区；不是简单更换配色。

| 模板 | 视觉语言 | 适用内容 |
| --- | --- | --- |
| 一封非空来信 | 暖色纤维纸、衬线标题、一体化信纸 | 随笔、日记、书信 |
| 素笺 | 高留白、弱边框、中性纸面 | 工作记录、教程、长文 |
| 夜读 | 深蓝黑渐变、暖金强调、低亮星点 | 诗歌、摘录、夜间随想 |
| 编辑部 | 瑞士编辑设计、偏置纸张、黑色边栏与珊瑚色锚点 | 观点、评论、短文 |
...
| 美术馆 | 展签白、偏置构图、色块编号系统 | 艺术笔记、作品说明、极简摘录 |
| 霓虹 | 黑紫背景、青色与洋红双光轨 | 音乐、科技、夜生活 |
